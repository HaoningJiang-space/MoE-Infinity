...
class OffloadEngine(object):
    ...
    def __init__(self, capacity, config: PretrainedConfig):
        ...
        self.phasea_recorder = None
        self.phasea_request_context = None
    ...
    def __enter__(self):
        ...
        def from_pretrained_decorator(
            ...
            def archer_from_pretrained(cls, *args, **kwargs):
                ...
                self.expert_prefetcher.prefetch_credit_gated_enabled = bool(
                    getattr(
                        self.archer_config,
                ...
                self.offloading_policy.attach_phasea_recorder(
                    self.phasea_recorder
                )
