...
ROOT="/data/ziheng/moe_infinity_fgo_runs/phasea_v10_runtime_fixedlen_qwen_pressure_sweep"
...
run_ratio() {
  ...
  for trace_name in mixed recurrence_heavy stationary; do
    ...
    run_case "$ratio_label" "$ratio" "$trace_name" history_reuse_backbone
...
run_ratio ratio_060 0.60
run_ratio ratio_045 0.45
run_ratio ratio_035 0.35
